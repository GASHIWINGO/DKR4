...
begin
textout(10, 100, 'Увеличить масштаб графика?');
viborp(l1);
case l1 of
1:
begin
...
begin
textcolor(11);
writeln('Найти площадь фигуры ограниченной кривой 2x^3-1x^2+5x+3');
textcolor(15);
writeln('Введите пределы интегрирования a и b (a<b)');
textcolor(4);
readln(a, b);
if (a > b) then begin
textcolor(14); writeln('a должен быть меньше b'); exit(); end;
textcolor(15);
...
writeln('Вывести график функции?');
vibor(l);
case l of
1:
begin
